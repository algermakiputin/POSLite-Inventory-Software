             		...
             		<tbody>
             			<?php foreach ($items as $key => $item): ?>
                            ...
                            <tr>
                 				...
                 				<td><?php echo $stocks <= 0 ? '<span class="label label-danger">Stock Out</span>' : ($stocks <= 5 ? '<span class="label label-warning ">Needs restock</span>' : '<span class="label label-success ">Available</span>') ?></td>
                 				<td>
