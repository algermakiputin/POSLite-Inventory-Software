...
<body>
				...
				<form method="POST">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input id="item" type="text" name="item" placeholder="Enter Item Name" class="form-control">
						</div>
					</div>
					<div class="col-sm-8">
						<div class="form-group">
	...
	<script type="text/javascript">
		$( document ).ready(function() {
			var list = <?php echo json_encode($names) ?>;
			...
			$('#process').on('click',function () {
				...
				var cart_items = [];
				var total = $("#amount_due").text().substring(1);
				...
				if (x === 1) {
					...
					for (row = 1; row < x; row++){
						...
						var r = $("#cart").find('tr').eq(row).find('input').val();
